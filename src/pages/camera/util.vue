<template>
  <view style="color: #fff; padding: 1rem; background: #000">
    <view class="d-flex" style=" padding-bottom: 50rpx">
      ...
      <view @click="ustate=false">
        ...
        <image style="width: 40rpx" mode="widthFix" src="https://hnenjoy.oss-cn-shanghai.aliyuncs.com/new_scantools/camera/close.png"/>
      </view>
    </view>
